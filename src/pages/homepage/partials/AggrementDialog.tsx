      ...
      >
        <DialogContent className='!bg-ggray !rounded-2xl'>
          ...
          <DialogContent className='!px-2 md:!px-12 !pb-5 !text-white !flex !flex-col gap-5 mt-4'>
            ...
            <Typography className='!font-heebo !font-light !text-sm !leading-relaxed text-justify'>PEMBLOKIRAN ATAU PENGHAPUSAN AKUN<br />
            ...
            <Typography className='!font-heebo !font-light !text-sm !leading-relaxed text-justify'>KEBIJAKAN PRIVASI DATA PEMOHON<br />
          ...
          <DialogActions className='!flex !justify-around !py-7 !flex-col'>
            <GButton className='w-full !text-sm' disabled={process} color='primary' onClick={onSubmit}>{process ? 'Memproses ...' : 'Saya setuju dengan ketentuan ini'}</GButton>

            <GButton className='w-full !mt-4 !text-sm !text-white' disabled={process} color='secondary' onClick={handleClose}>Batal</GButton>
          </DialogActions>
        </DialogContent>
      </Dialog>
    </React.Fragment>
