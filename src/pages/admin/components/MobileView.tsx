...
export default function MobileView({data,setSearch,setPerPage,setDownloadProgress,downloadProgress,paginate,setPage,downloadForm,setConfirm,downloadFile,process}:MobileViewProps){
    return (
        <>
